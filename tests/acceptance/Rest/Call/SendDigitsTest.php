 ...
 *
 */
class SendDigitsTest extends AbstractAcceptanceTest
{
    public static array $deferred = [];

    public function testSendDigits(): void
    {
        $this->doSendDigits('false');
    }

    public function testSendDigitsPreanswer(): void
    {
        $this->doSendDigits('true');
    }

    public function doSendDigits(string $preanswer): void
    {
